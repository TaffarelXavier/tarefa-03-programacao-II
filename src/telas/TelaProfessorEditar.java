...
public class TelaProfessorEditar extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public TelaProfessorEditar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    final void prencherListaDisciplina(){
        ...
        try {
            ...
            for (Disciplina disciplina : disciplinas) {
                jComboBoxDisciplina.addItem(disciplina.getNomeDisciplina());
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaProfessorEditar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaProfessorEditar dialog = new TelaProfessorEditar(new javax.swing.JFrame(), true);
