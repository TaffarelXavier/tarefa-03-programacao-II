...
/**
 *
 * @author Taffarel Xavier <taffarel_deus@hotmail.com> e
 * @author Ramon Deyvid <ramon.dayvid08@gmail.com>
 */
public class Cad_Aluno extends javax.swing.JDialog {
     ...
     * @param aAcao
     */
    public Cad_Aluno(java.awt.Frame parent, boolean modal, String aAcao) {
        ...
        try {
            ...
            Logger.getLogger(Cad_Aluno.class.getName()).log(Level.INFO, null, ex);
        }
    }
    ...
    private void initComponents() {
                                    ...
                                    .addGroup(jPanelMatriculaLayout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanelMatriculaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(jPanelMatriculaLayout.createSequentialGroup()
                                                ...
                                                .addGap(106, 106, 106))
                                            .addGroup(jPanelMatriculaLayout.createSequentialGroup()
                                                .addComponent(jComboBoxResultado, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))))
                                    .addGroup(jPanelMatriculaLayout.createSequentialGroup()
        ...
        jButtonSalvarAlteracoes.setBackground(new java.awt.Color(51, 153, 0));
        jButtonSalvarAlteracoes.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jButtonSalvarAlteracoes.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/save-icon.png"))); // NOI18N
        jButtonSalvarAlteracoes.setText("SALVAR");
        jButtonSalvarAlteracoes.setBorder(null);
        jButtonSalvarAlteracoes.setContentAreaFilled(false);
        jButtonSalvarAlteracoes.setEnabled(false);
        jButtonSalvarAlteracoes.setOpaque(true);
        ...
        jButtonMatricular.setBackground(new java.awt.Color(204, 204, 204));
        jButtonMatricular.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jButtonMatricular.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/save-as-icon.png"))); // NOI18N
        jButtonMatricular.setText("MATRICULAR");
        jButtonMatricular.setBorder(null);
        ...
        jButtonExcluirAluno.setBackground(new java.awt.Color(255, 51, 51));
        ...
        jButtonExcluirAluno.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/trash-icon.png"))); // NOI18N
        jButtonExcluirAluno.setText("EXCLUIR ALUNO");
        jButtonExcluirAluno.setBorder(null);
        jButtonExcluirAluno.setContentAreaFilled(false);
        jButtonExcluirAluno.setEnabled(false);
        jButtonExcluirAluno.setOpaque(true);
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(jButtonExcluirAluno, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jButtonMatricular, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jButtonSalvarAlteracoes, javax.swing.GroupLayout.PREFERRED_SIZE, 176, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        if (acao.equals("editar")) { //Alteração
            ...
            if (isMatricular) { //Caso o usuário tenha clicado em matricular:
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Escolha todos os campos, a saber: turma e curso.", "Atenção", 1);
                }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Cad_Aluno dialog = new Cad_Aluno(new javax.swing.JFrame(), true, "incluir");
